 ...
 */
package uk.org.funcube.fcdw.satellite;
...
public class TLE implements Serializable {
	...
	public TLE(long catnum, String name, int setnum, int year, double refepoch,
			...
			double bstar, long orbitnum, double epoch, double xndt2o,
			double xincl, double xnodeo, double eo, double omegao, double xmo,
			double xno, boolean deepspace, Date createddate) {
		super();
		this.catnum = catnum;
		this.name = name;
		this.setnum = setnum;
