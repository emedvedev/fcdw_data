        ...
        for (int channel = 1; channel <= 14; channel++) {
            ...
            switch (channel) {
                ...
                case 6:
                    ...
                    break;
            /*
             * case 11: // Solar panel temp +X if (wodEntity.getC5() == 0) { break; } if
             * (wodEntity.getC5() < minMaxEntity.getMinimum()) {
             * minMaxEntity.setMinimum(wodEntity.getC5()); } else if (wodEntity.getC5() >
             * minMaxEntity.getMaximum()) { minMaxEntity.setMaximum(wodEntity.getC5()); } break;
             * case 12: // Solar panel temp -X if (wodEntity.getC6() == 0) { break; } if
             * (wodEntity.getC6() < minMaxEntity.getMinimum()) {
             * minMaxEntity.setMinimum(wodEntity.getC6()); } else if (wodEntity.getC6() >
             * minMaxEntity.getMaximum()) { minMaxEntity.setMaximum(wodEntity.getC6()); } break;
             * case 13: // Solar panel temp +Y if (wodEntity.getC7() == 0) { break; } if
             * (wodEntity.getC7() < minMaxEntity.getMinimum()) {
             * minMaxEntity.setMinimum(wodEntity.getC7()); } else if (wodEntity.getC7() >
             * minMaxEntity.getMaximum()) { minMaxEntity.setMaximum(wodEntity.getC7()); } break;
             * case 14: // Solar panel temp -Y if (wodEntity.getC8() == 0) { break; } if
             * (wodEntity.getC8() < minMaxEntity.getMinimum()) {
             * minMaxEntity.setMinimum(wodEntity.getC8()); } else if (wodEntity.getC8() >
             * minMaxEntity.getMaximum()) { minMaxEntity.setMaximum(wodEntity.getC8()); } break;
             */
            }
