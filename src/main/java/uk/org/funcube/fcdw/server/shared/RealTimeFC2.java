...
public class RealTimeFC2 extends RealTime {
    ...
    public RealTimeFC2(final int satelliteId, final int frameType, final int sensorId, final Date now,
     ...
     */
    public RealTimeFC2(final RealTimeEntity realTimeEntity) {
    ...
    /*
     * Current -3.200E+00 2.926E+03 Volts -9.470E-03 * 4.0 9.798896E+00 Temp -1.630E-01 4.753E+00
     */
    ...
    public String getBattery2TemperatureString() {
        return String.format("%5.1f", (battery2Temperature * -1.630E-01 * 4) + 75.0);
    }
    ...
    public String getPaDeviceTemperatureString() {
        // .29764694373E+001 + 3.80132039683E-001 *X -9.59767044686E-003
        // *x^2+5.15917746352E-005*x^3-9.77975220499E-008*x^4
        final double value = 6.29764694373E+001
    ...
    public String getMagnetometerMagnitudeString() {
        return String.format("%7d", getMagnetometerMagnitude());
    }
