...
public class AsibSummary {
    ...
    public AsibSummary(final String solarPanelTempXplus, final String solarPanelTempXminus,
            final String solarPanelTempYplus, final String solarPanelTempYminus,
            final String busVoltageThree, final String busCurrentThree,
            final String busVoltageFive) {
        super();
